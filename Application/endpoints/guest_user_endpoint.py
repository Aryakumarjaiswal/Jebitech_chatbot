...
#     session_id, user_id = ensure_guest_session(db)
        ...
        #         if property_name == "No matching property found.":
        #             user.ended_at = datetime.utcnow()
        #             message_container=f"\n USER-> {user_input}\n RESPONSE->Please provide proper property name"
        ...
        #             return {"session_id": session_id,
        #      "User: ":user_input,
        #      "AI Response: ":"Please provide proper property name"}
                
                #generated_sql = f"select summary from property_data_live where nick_name ='{property_name}' or property_building ='{property_name}';"
